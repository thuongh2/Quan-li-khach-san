            ...
            <div class="col-lg-8 posts-list">
               <div class="single-post">
                  ...
                  <div class="blog_details">
                     ...
                     <p class="excert">
                       Diện tích: ${hotel.hotelDetail.area } m2
                     </p>
                      <p class="excert">
                       Giá phòng: ${hotel.hotelDetail.price } VNĐ
                     </p>
                        ...
                        <div class="user justify-content-between d-flex">
                           ...
                           <div class="desc">
                              ...
                              <div class="d-flex justify-content-between">
                                 ...
                                 <div class="reply-btn">
                                    <a href="RoomServlet?id=${hotel.id}&comment=${comment.id}&action=delete-comment" class="btn-reply text-uppercase">DELETE</a>
                                 </div>
                              </div>
                           </div>
                        </div>
               ...
               <div class="comment-form">
                  <h4>Leave a Reply</h4>
                  <form class="form-contact comment_form" action="${pageContext.request.contextPath }/RoomServlet?id=${hotel.id}&action=create-comment" method="post" id="commentForm">
                     <div class="row">
                        <div class="col-12">
                     ...
                     <form action="#">
                        <div class="form-group">
                           <div class="input-group mb-3">
                              <input type="text" name="content" class="form-control" placeholder='Search Keyword'
